...
export const actionHandler = (payload) => {
  ...
  if (accessToken && payload?.url !== 'api/method/frappe.core.doctype.user.user.login') {
    if (payload?.url === '/api/resource/EOI%20For%20Land?fields=[%22name%22,%22district2%22,%22land_name%22,%22total_availability_of_land_in_acres_%22,%20%22total_availability_of_land_in_units_%22]' || payload?.url === "/api/resource/EOI%20For%20Land") {
